          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                whileHover="hover"
                className="text-white p-2 bg-gradient-to-tr from-secondary to-accent rounded-full border border-gray-300 dark:border-gray-700/30 hover:opacity-90 transition-opacity"
              >
