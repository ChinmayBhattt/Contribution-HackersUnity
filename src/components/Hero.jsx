...
const Hero = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 via-gray-100 to-blue-50 dark:from-primary dark:via-primary/95 dark:to-primary-900 relative overflow-hidden py-16 md:py-20 min-h-[90vh] flex items-center">
