...
const Hero = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 via-gray-100 to-blue-50 dark:from-primary dark:via-primary/95 dark:to-primary-900 relative overflow-hidden pt-28 pb-16 md:pt-32 md:pb-24 min-h-screen flex items-center">
